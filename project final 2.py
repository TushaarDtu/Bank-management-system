...
def details(n):
    ...
    while True:
        ...
        if s=="":
            break
        if int(p[0])==n:
            x=Label(f1,text=p[2],fg="white",bg="black",font="AdobeFanHeitiStdB 14 bold").pack(padx=80)
            l= Label(f1,bg="black")
            l.pack(pady=1)
            break

    k1=Button(f1,text="   main menu   ",fg="white",bg="black",font="AdobeFanHeitiStdB 14 bold",command=maine).pack(side = TOP,padx=5)
    f1.place(x=450,y=230,width=480,height=555)
...
def forwhat(i):
    ...
    if i==1:
        f=Frame(f1)
        f.config(background="black")
        b1= Button(f1,text="Submit",bg="black",fg="white",font="AdobeFanHeitiStdB 14 bold",borderwidth=2,relief=SUNKEN,command=lambda:details(de.get()))
        ...
        f=Frame(f1)
        f.config(background="black")
        b1= Button(f1,text="Submit",bg="black",fg="white",font="AdobeFanHeitiStdB 14 bold",borderwidth=2,relief=SUNKEN,command=lambda:decrease(de.get()))
        # b1.place(x=200,y=370)
        b1.pack(pady=20)
        f.pack(side=BOTTOM,pady=5)
        ...
        f=Frame(f1)
        f.config(background="black")
        k=Label(f,text="Enter Amount",fg="white",bg="black",font="AdobeFanHeitiStdB 14 bold").pack(side=LEFT,padx=5,pady=5)
        E5=Entry(f,textvariable=d).pack(side=LEFT,pady=10)
        l= Label(f,bg="black")
        l.pack(side=TOP,pady=5)
        f.pack(side=TOP,pady=15)
        f=Frame(f1)
        f.config(background="black")
        b1= Button(f1,text="Submit",bg="black",fg="white",font="AdobeFanHeitiStdB 14 bold",borderwidth=2,relief=SUNKEN,command=lambda:increase(de.get(),d.get()))
